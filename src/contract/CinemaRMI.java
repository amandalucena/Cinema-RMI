...
public interface CinemaRMI extends Remote {
     ...
     * @return uma Lista de objetos FilmeDTO.
     * @throws RemoteException se ocorrer um erro de comunicação RMI.
     */
    List<FilmeDTO> listarFilmes() throws RemoteException;
     ...
     * @return uma Lista de objetos SessaoDTO.
     * @throws RemoteException se ocorrer um erro de comunicação RMI.
     */
    List<SessaoDTO> listarSessoesPorFilme(int filmeId) throws RemoteException;
